...
const Projects = () => {
  ...
  <img src="https://i.ibb.co/WsYs0TJ/rsz-pp.png" alt="Example image" className=" p-5 h-64 transform transition duration-500 hover:scale-110 w-96 rounded-lg"/>
  <p class="font-bold text-xl pb-5 text-center text-yellow-100">Phone Pocket</p>
  <div class="absolute inset-0 bg-gray-800 opacity-0 hover:opacity-90 flex justify-center items-center h-72">
     <Link><span style={{ fontFamily: 'Fira Code' }} class="inline-block bg-blue-600 rounded-lg px-3 py-1 font-semibold text-white mr-2 mb-2 text-lg">Live Site</span>
      ...
      <span style={{ fontFamily: 'Fira Code' }} class="inline-block bg-blue-600 rounded-lg px-3 py-1 text-lg font-semibold text-white mr-2 mb-2">See Details</span>
       ...
       <div className='bg-gray-400 rounded-lg transform transition duration-2000 hover:scale-125'>
                <div class="relative w-full h-72 rounded-lg">
  <img src="https://i.ibb.co/hZMb385/GST-Rate-for-Photography-Services.png" alt="Example image" className=" p-5 h-64 transform transition duration-500 hover:scale-110 w-96 rounded-lg"/>
  <p class="font-bold text-xl pb-5 text-center text-yellow-100">Lens Eye Photography</p>
  <div class="absolute inset-0 bg-gray-800 opacity-0 hover:opacity-90 flex justify-center items-center h-72">
     <Link><span style={{ fontFamily: 'Fira Code' }} class="inline-block bg-blue-600 rounded-lg px-3 py-1 font-semibold text-white mr-2 mb-2 text-lg">Live Site</span>
     </Link>
      <Link>
     ...
     <div className='bg-gray-400 rounded-lg transform transition duration-2000 hover:scale-125'>
                <div class="relative w-full h-72 rounded-lg">
  <img src="https://i.ibb.co/bF6qwM7/Bit-Masters.png" alt="Example image" className=" p-5 h-64 transform transition duration-500 hover:scale-110 w-96 rounded-lg"/>
  <p class="font-bold text-xl pb-5 text-center text-yellow-100">Bit Masters</p>
  <div class="absolute inset-0 bg-gray-800 opacity-0 hover:opacity-90 flex justify-center items-center h-72">
     <Link ><span style={{ fontFamily: 'Fira Code' }} class="inline-block bg-blue-600 rounded-lg px-3 py-1 font-semibold text-white mr-2 mb-2 text-lg">Live Site</span>
     </Link>
      <Link>
      ...
      <div className='bg-gray-400 rounded-lg transform transition duration-2000 hover:scale-125'>
                <div class="relative w-full h-72 rounded-lg">
  <img src="https://i.ibb.co/rvmsbc6/CG1.png" alt="Example image" className=" p-5 h-64 transform transition duration-500 hover:scale-110 w-96 rounded-lg"/>
  <p class="font-bold text-xl pb-5 text-center text-yellow-100">Code Genius</p>
  <div class="absolute inset-0 bg-gray-800 opacity-0 hover:opacity-90 flex justify-center items-center h-72">
     <Link ><span style={{ fontFamily: 'Fira Code' }} class="inline-block bg-blue-600 rounded-lg px-3 py-1 font-semibold text-white mr-2 mb-2 text-lg">Live Site</span>
     </Link>
      <Link>
      ...
      <div className='bg-gray-400 rounded-lg transform transition duration-2000 hover:scale-125'>
                <div class="relative w-full h-72 rounded-lg">
  <img src="https://i.ibb.co/g7vqKdt/DN1.png" alt="Example image" className=" p-5 h-64 transform transition duration-500 hover:scale-110 w-96 rounded-lg"/>
  <p class="font-bold text-xl pb-5 text-center text-yellow-100">Dragon News</p>
  <div class="absolute inset-0 bg-gray-800 opacity-0 hover:opacity-90 flex justify-center items-center h-72">
     <Link ><span style={{ fontFamily: 'Fira Code' }} class="inline-block bg-blue-600 rounded-lg px-3 py-1 font-semibold text-white mr-2 mb-2 text-lg">Live Site</span>
     </Link>
      <Link>
