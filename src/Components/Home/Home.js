      ...
      <div className="lg:flex shadow-white lg:flex-row h-auto md:flex md:flex-row sm:flex sm:flex-col justify-between items-center	 w-[90%] mx-auto rounded-b-2xl p-10">
        <div className="w-[70%]  md:w-[70%] sm:w-full leading-10">
          <h1
            ...
            className="text-5xl sm:my-10 md:my-10 lg:my-5 sm:text-center md:text-center lg:text-left text-white font-bold"
          >
            Greetings from the H3X!
          </h1>
          <p className="sm:text-center md:text-center lg:text-left text-white text-2xl">
            Welcomed By Sadman Yasir Rafat
          </p>
          <p
            style={{ fontFamily: "Fira Code" }}
            className="sm:text-center text-2xl text-gray-400 md:text-center lg:text-left"
          >
            {" "}
            <Typewriter
              words={[
          ...
          <button className="text-white bg-gradient-to-br from-purple-600 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 mt-5 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2 sm:w-1/2 sm:mx-auto">
            Check Out My Resume
          </button>
          <p className="mt-15 text-xl text-gray-400">
