...
const Contact = () => {
    return (
        <div className='w-[90%] mx-auto my-20'>
             <h1  className='text-5xl text-center my-10 text-white font-bold'>Lets Talk about everything</h1>
            <div className='lg:flex lg:flex-row md:flex-row sm:flex-col justify-center align-middle '>
   ...
   <div class="relative z-10 w-full max-w-2xl mt-20 lg:mt-0 lg:w-10/12">
      <div class="relative z-10 flex flex-col items-start justify-start p-10 bg-white shadow-2xl rounded-xl">
         ...
         <form class="relative w-full mt-6 space-y-8">
            ...
            <div class="relative">
               <label for="large-input" class="absolute px-2 ml-2 -mt-3 font-medium text-gray-600 bg-white">Your Message</label>
               <textarea type="textArea" class="block w-full px-4 py-4 mt-2 text-base placeholder-gray-400 bg-white border border-gray-300 rounded-md focus:outline-none focus:border-black" placeholder="Hi! I am john doe..."/>
            </div>
            <div class="relative">
               <button class="inline-block w-full px-5 py-4 text-xl font-medium text-center text-white transition duration-200 bg-blue-600 rounded-lg hover:bg-blue-500 ease">Start Conversation</button>
            </div>
         </form>
      </div>
